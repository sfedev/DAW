...
public class CsvProcessorRiegos {

    public static void insertIntoRiegos(Connection conn, File directoryPath) {
        String insertQuery = "INSERT INTO Riegos(id, tipo, velocidad, id_plantacion) VALUES (?, ?, ?, ?)";
    ...
    private static void updateRecordInDatabase(Connection conn, String[] newValues) {
        String updateQuery = "UPDATE Riegos SET tipo=?, velocidad=?, id_plantacion=? WHERE id=?";
