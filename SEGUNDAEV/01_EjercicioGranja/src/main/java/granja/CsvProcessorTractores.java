...
public class CsvProcessorTractores {

    public static void insertIntoTractores(Connection conn, File directoryPath) {
                        ...
                        try (BufferedReader br = Files.newBufferedReader(file.toPath())) {
                            ...
                            while ((line = br.readLine()) != null) {
                                ...
                                try (PreparedStatement preparedStatement = conn.prepareStatement(insertQuery)) {
	                                ...
	                                if (rowData.length >= 5 && !rowData[4].isEmpty()) {
    ...
    private static void updateRecordInDatabase(Connection conn, String[] newValues) {
        String updateQuery = "UPDATE Tractores SET modelo=?, velocidad=?, precio_venta=?, id_construccion=? WHERE id=?";
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(updateQuery)) {
            ...
            preparedStatement.setInt(2, Integer.parseInt(newValues[2]));
            preparedStatement.setFloat(3, Float.parseFloat(newValues[3]));
            preparedStatement.setInt(4, Integer.parseInt(newValues[4]));
            preparedStatement.setInt(5, Integer.parseInt(newValues[0]));
